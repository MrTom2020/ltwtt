...
define("SMTP_UNAME", "tomhumchinvn@gmail.com"); //Username for SMTP authentication any valid email created in your domain
define("matkhau", "hiep1234"); //Password for SMTP authentication
