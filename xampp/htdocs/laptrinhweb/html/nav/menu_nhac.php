...
<nav class="ph-lift">
        <ul>
            <li class="active"><a href="../html/danhsachnhac.php" data-title="Chọn bài hát">Chọn bài hát</a></li>
            <li class="active"><a href="../html/themnhac.php" data-title="Thêm nhạc">Thêm nhạc</a></li>
        <ul>
</nav>    
